	...
	public static void main(String[] args) {
		try (Scanner inputScanner = new Scanner(System.in)) {
			...
			while (!EXIT_STRING.equals(inputproduct)) {
				System.out.println("Select your product from [" + ProductAndOfferInventoryService.getAllProductName(productAndOfferInventory) +"]. For checkout type: "+EXIT_STRING);
				...
				if(productIterm == null) {
					...
					System.out.println("Your running total is : " + ShopingBasketService.getBasketTotal(basket));
				} 
